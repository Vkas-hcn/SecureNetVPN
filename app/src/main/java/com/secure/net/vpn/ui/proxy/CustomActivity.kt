...
import com.secure.net.vpn.databinding.ActivityCustomBinding
...
class CustomActivity  : BaseActivity<ActivityCustomBinding, ProxyViewModel>() {
    ...
    private fun initAllAdapter() {
        ...
        binding.rvListApp.layoutManager = androidx.recyclerview.widget.LinearLayoutManager(this)
